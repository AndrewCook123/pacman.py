...
while run:
    ...
    game.draw_player(direction, player_x, player_y, counter)
    ...
    clyde = Ghost(clyde_x, clyde_y, targets[3], ghost_speeds[3], clyde_img, clyde_direction, clyde_dead,
                  clyde_box, 3)
    game.draw_misc(game_won, game_over, lives)
    targets = game.get_targets(blinky_x, blinky_y, inky_x, inky_y, pinky_x, pinky_y, clyde_x, 
                                clyde_y, blinky, pinky, inky, clyde, player_x, player_y)

    turns_allowed = game.check_position(center_x, center_y, direction, level)
    if moving:
        player_x, player_y = game.move_player(player_x, player_y, turns_allowed, direction)
    ...
    score, powerup, power_counter, eaten_ghost = game.check_collisions(score, powerup, power_counter, eaten_ghost, center_x, center_y, player_x, level)
