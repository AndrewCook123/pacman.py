...
class Level(object):
    ...
    def gameLoop(self):
        ...
        while run:
            ...
            game.draw_player(self.direction, self.player_x, self.player_y, self.counter)
            ...
            game.draw_misc(self.game_won, self.game_over, self.lives)
            self.targets = game.get_targets(self.blinky_x, self.blinky_y, self.inky_x, self.inky_y, self.pinky_x, self.pinky_y, self.clyde_x, 
                                        self.clyde_y, blinky, pinky, inky, clyde, self.player_x, self.player_y, self.powerup)

            self.turns_allowed = game.check_position(self.center_x, self.center_y, self.direction, self.level)
            if self.moving:
                self.player_x, self.player_y = game.move_player(self.player_x, self.player_y, self.turns_allowed, self.direction)
            ...
            self.score, self.powerup, self.power_counter, self.eaten_ghost = game.check_collisions(self.score, self.powerup, self.power_counter, self.eaten_ghost, self.center_x, self.center_y, self.player_x, self.level)
