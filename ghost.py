...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 19 18:14:15 2023
...
class Ghost(object):
    def __init__(self, x_coord, y_coord, target, speed, img, direct, dead, box, powerup, id, screen, eaten_ghost, level):
        ...
        self.turns, self.in_box = self.check_collisions(self.level)
        self.rect = self.draw(self.screen, self.eaten_ghost, self.spooked_img, self.dead_img)
