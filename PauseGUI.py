...
class Pause(object):
    ...
    def show(self) -> bool:
        ''' This function displays the pause button on screen. '''
        self.clicked_resume = False
    ...
    def PauseMenu(self) -> bool:
        ''' This function draws the pause menu with the resume button on screen. '''
        pos = pygame.mouse.get_pos()
    ...
    def quit_button(self) -> bool:
        ''' This function draws the quit button onto the pause menu. '''
        pos = pygame.mouse.get_pos()
        quits = pygame.draw.rect(self.screen, 'Blue', [470, 335, 150, 50], 0, 10)
        quit_text = self.font.render(f'Quit', True, 'white')
    ...
    def start_over(self) -> None:
        ''' This function sets the value of the clicked_quit variable. '''
        self.clicked_quit = False
